...
public class ReactCBLite extends ReactContextBaseJavaModule {
    ...
    public void init(Callback callback) {
        ...
        this.initWithCredentials(allowedCredentials, null, callback);
    }
    ...
    public void initWithAuth(String username, String password, Callback callback) {
        ...
        this.initWithCredentials(credentials, null, callback);
    }

    @ReactMethod
    public void initWithAuthAndEncryptionKey(String username, String password, String encryptionKey, Callback callback) {
        initWithCredentials(new Credentials(username, password), encryptionKey, callback);
    }

    private void initWithCredentials(Credentials credentials, String encryptionKey, Callback callback) {
        ...
        try {
            ...
            if (encryptionKey != null) manager.registerEncryptionKey(encryptionKey, "smt");
